...
export enum ActionTypes {
    ...
    // Custom Data
    INIT_CUSTOM_DATA = 'INIT_CUSTOM_DATA',
    UPDATE_REGION = 'UPDATE_REGION',
    INCREASE_MAX_TRACK_ID = "INCREASE_MAX_TRACK_ID",
    DECREASE_MAX_TRACK_ID = "DECREASE_MAX_TRACK_ID",
    UPDATE_CURRENT_TRACK_ID = "UPDATE_CURRENT_TRACK_ID",

    // Frame Data
    INIT_FRAME_DATA = 'INIT_FRAME_DATA',
